...
#line 1 "/home/ansorge/workspace_master/manta/source/plugin/numpyconvert.cpp"
/******************************************************************************
*
...
void copyGridToArrayMAC(const MACGrid& _Source, PyArrayContainer target) {
...
void copyArrayToPdataInt(ParticleDataImpl<int> &p, const PyArrayContainer n) { 
	numpyToParticleDataImpl<int>(p, n); 
}
void copyPdataToArrayInt(PyArrayContainer n, const ParticleDataImpl<int> &p) { 
	particleDataImplToNumpy<int>(n, p); 
}

void copyArrayToPdataReal(ParticleDataImpl<Real> &p, const PyArrayContainer n) { 
	numpyToParticleDataImpl<Real>(p, n); 
}
void copyPdataToArrayReal(PyArrayContainer n, const ParticleDataImpl<Real> &p) { 
	particleDataImplToNumpy<Real>(n, p); 
}

void copyArrayToPdataVec3(ParticleDataImpl<Vec3> &p, const PyArrayContainer n) {
...
void copyPdataToArrayVec3(PyArrayContainer n, const ParticleDataImpl<Vec3> &p) {
	assertMsg(n.TotalSize == p.size()*3, "Sizes are different!");
