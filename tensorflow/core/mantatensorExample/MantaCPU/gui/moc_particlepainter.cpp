...
struct qt_meta_stringdata_Manta__ParticlePainter_t {
    QByteArrayData data[1];
    char stringdata0[23];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Manta__ParticlePainter_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Manta__ParticlePainter_t qt_meta_stringdata_Manta__ParticlePainter = {
    {
QT_MOC_LITERAL(0, 0, 22) // "Manta::ParticlePainter"

    },
    "Manta::ParticlePainter"
};
...
const QMetaObject Manta::ParticlePainter::staticMetaObject = {
    { &LockedObjPainter::staticMetaObject, qt_meta_stringdata_Manta__ParticlePainter.data,
      qt_meta_data_Manta__ParticlePainter,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Manta::ParticlePainter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Manta__ParticlePainter.stringdata0))
